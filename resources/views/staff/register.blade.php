...
<main id="main" class="main">
    <div class="card">
        <div class="card-body">
          <h5 class="card-title">Create a New Staff Profile</h5>
          ...
          <form class="row g-3" method="POST" action="{{ route('StaffRegistered') }}">
            @csrf

            <input type="hidden" class="form-control id" id="role" name="role" value="Staff">
          ...
          c0.001-0.001,0.002-0.001,0.003-0.002l6.19,5.238C36.971,39.205,44,34,44,24C44,22.659,43.862,21.35,43.611,20.083z"></path>
                ...
                <a href="{{ url('student/login/google') }}">
